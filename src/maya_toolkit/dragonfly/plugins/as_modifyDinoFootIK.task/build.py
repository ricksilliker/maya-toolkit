...
# Add attrs
foot_attrs = [ 'heelBall', 'heelBallAngle', 'toesUpDn', 'ballSwivel', 'heelSwivel', ]
...
# Connect foot attrs
cmds.connectAttr( '{}.'.format(foot_ctl), '{}.rock'.format(foot_ctl) )
...
def run(params, rig):
    ...
    for footIK in params['footIKControls']:
        ...
        # Hide existing attrs
        foot_attrs_hide = ['swivel', 'roll', 'rollAngle']
        for foot_attr_hide in foot_attrs_hide:
